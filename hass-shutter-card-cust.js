class ShutterCardCust extends HTMLElement {
  set hass(hass) {
    const _this = this;
        ...
        shutter.innerHTML = `
          ...
          <div class="sc-shutter-middle" style="flex-flow: ` + (buttonsInRow ? 'column': 'row') + (buttonsContainerReversed ? '-reverse' : '') + ` nowrap;">
            <div class="sc-shutter-buttons" style="flex-flow: ` + (buttonsInRow ? 'row': 'column') + ` wrap;">
              ...
              ` +
          `<ha-icon-button label="Auto close today" id="sc-shutter-button-autoclose" class="sc-shutter-button" data-command="auto-close"><ha-icon icon="mdi:close-box"></ha-icon></ha-icon-button>`
...
customElements.define("shutter-card-cust", ShutterCardCust);
